...
namespace OnlineShopapi.Controllers
{
    ...
    public class Customercontroller : ControllerBase
    {
        ...
        public async Task<IActionResult> AddCustomerAsync([FromBody] AddCustomerDto addCustomerDto)
        {
            ...
            return Ok($"{customer.FullName} with IdNumber {customer.Id} is registered");
        }
        [HttpGet]
        [Route("Get/{id}")]
        ...
        {
            var customer = await _customerRepository.UpdateCustomerAsync(id, updateCustomerDto);
            return Ok(customer == null ? $"Not found the CustomerId" : $"{customer.FullName} is updated" );
        }
        ...
        public async Task<IActionResult> DeleteCustomerAsync(int id)
        {
            ...
            return Ok(customer == null ? $"Not found the CustomerId" : $"{customer.FullName} is deleted");
        }
    }
}